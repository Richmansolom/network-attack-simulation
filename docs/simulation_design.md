...
|--------|-----------|-------------|
| **Binomial** | p (detection_prob) | **Phase 3 standard factorial (H1)** uses **5 levels**: **0.30, 0.50, 0.70, 0.85, 0.95** (`GUIDE_FACTORIAL_DETECTION_PROBS`; replaces legacy **0.70–0.95**) |
